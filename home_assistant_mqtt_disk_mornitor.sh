...
size=`df -h $1 | awk '{ print $2 }' | tail -n 1 | cut -d 'G' -f1`
available=`df -h $1 | awk '{ print $4 }' | tail -n 1 | cut -d 'G' -f1`
used=`df -h $1 | awk '{ print $3 }' | tail -n 1 | cut -d 'G' -f1`
used_percentage=`df -h $1 | awk '{ print $5 }' | tail -n 1 | cut -d '%' -f1`
